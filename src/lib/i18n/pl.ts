...
export const pl = {
  ...
  authoring: {
    ...
    toolbarApprove: "Zatwierdź i graj ▶",
    ...
    inspectorNoSelection: "Kliknij węzeł na grafie",
    inspectorNoSelectionDetails: "Zobaczysz tutaj tytuł sceny, obecnych BN-ów, poziom napięcia i warunki przejścia. Włącz Tryb edycji w pasku narzędzi, aby zmieniać zawartość.",
    onboardingTitle: "Twój graf sesji jest gotowy!",
    onboardingBody: "To mapa Twojej sesji — sceny, BN-i, powiązania fabularne.",
    onboardingStep1: "Przejrzyj graf — kliknij węzły, aby zobaczyć szczegóły",
    onboardingStep2: "Włącz Tryb edycji, aby zmienić tytuły, opisy i BN-ów w scenach",
    onboardingStep3: 'Kliknij "Zatwierdź i graj" gdy będziesz gotowy do gry',
    onboardingNote: "Możesz od razu zatwierdzić i zacząć grę — graf jest gotowy. Na razie nie można dodawać ani usuwać węzłów — ta funkcja pojawi się wkrótce.",
  ...
  play: {
    ...
    ttsToggleOn: "Włącz narrację głosową (tryb solo)",
